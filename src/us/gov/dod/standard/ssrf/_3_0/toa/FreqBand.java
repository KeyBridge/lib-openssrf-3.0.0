...
public class FreqBand {
   ...
   * Get
   * <p>
   * @return the BandNotes value in a {@link TString} data type
   * @since 3.1.0
   */
   ...
   * Set
   * <p>
   * @param value the BandNotes value in a {@link TString} data type
   * @since 3.1.0
   */
  ...
  /**
   * Determine if the BandNotes is configured.
   * <p>
   * If configured this method also inspects the {@link TString} wrapped value.
   * <p>
   * @return TRUE if the field is set, FALSE if the field is null
  ...
  public boolean isSetBandNotes() {
    return (this.bandNotes != null ? this.bandNotes.isSetValue() : false);
  }
  ...
  public String toString() {
    return "FreqBand {"
      ...
      + (bandNotes != null ? " bandNotes [" + bandNotes + "]" : "")
      + "}";
  }
