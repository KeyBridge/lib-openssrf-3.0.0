...
public class ConfigEmission {
   ...
   * US:NecessaryBwMin.
   * <p>
   * @return the NecessaryBwMax value in a {@link TDecimal} data type
   * @since 3.1.0
   */
   ...
   * US:NecessaryBwMin.
   * <p>
   * @param value the NecessaryBwMax value in a {@link TDecimal} data type
   * @since 3.1.0
   */
   ...
   * bandwidths, enter the minimum necessary bandwidth.
   * <p>
   * @return the NecessaryBwMin value in a {@link TDecimal} data type
   * @since 3.1.0
   */
   ...
   * bandwidths, enter the minimum necessary bandwidth.
   * <p>
   * @param value the NecessaryBwMin value in a {@link TDecimal} data type
   * @since 3.1.0
   */
