...
public class RxModeRef {
   ...
   * @return The current RxModeRef object instance
   * @since 3.1.0
   */
   ...
   * @since 3.1.0
   */
  public RxModeRef withRemarks(BigInteger... values) {
    if (values != null) {
   ...
   * @since 3.1.0
   */
  public RxModeRef withRemarks(Collection<BigInteger> values) {
    if (values != null) {
   ...
   * @since 3.1.0
   */
  public RxModeRef withExtReferences(BigInteger... values) {
    if (values != null) {
   ...
   * @since 3.1.0
   */
  public RxModeRef withExtReferences(Collection<BigInteger> values) {
    if (values != null) {
   ...
   * <p>
   * {@link RxModeRef} requires {@link ListCCL cls}.
   * <p>
